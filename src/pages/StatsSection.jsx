  ...
  return (
    <div className="bg-gray-100 py-6 sm:py-8 md:py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className=" grid grid-cols-2 gap-4 lg:grid-cols-4  border-gray-300 p-4">
          {/* Stat Item 1 */}
          <div className="text-center border p-4">
            <div className="mx-auto mb-3 w-16 h-16">
              <img src={stationSectio1} alt="Expert counsellors available" className="object-contain w-7.5 h-7.5" />
            </div>
          ...
          <div className="text-center border p-4">
            <div className="mx-auto mb-3 w-16 h-16">
              <img src={stationSectio2} alt="Educational programs offered" className="object-contain w-7.5 h-7.5l" />
            </div>
          ...
          <div className="text-center border p-4">
            <div className="mx-auto mb-3 w-16 h-16">
              <img src={stationSectio3} alt="Students enrolled" className="object-contain w-7.5 h-7.5" />
            </div>
          ...
          <div className="text-center border p-4">
            <div className="mx-auto mb-3 w-16 h-16">
              <img src={stationSectio4} alt="Partner universities" className="object-contain w-7.5 h-7.5" />
            </div>
